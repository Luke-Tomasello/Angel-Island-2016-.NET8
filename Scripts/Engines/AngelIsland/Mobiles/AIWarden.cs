...
namespace Server.Mobiles
{
    public class AIWarden : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.25, 0.5)
        {
            ...
            Bandage bandages = new Bandage(Utility.RandomMinMax(1, 15));
            bandages.LootType = LootType.Newbied;
            PackItem(bandages);
        ...
        public void FoundPlayer(Mobile m)
        {
            try
            {
                ...
                // tidy the list
                List<Mobile> cleanup = new List<Mobile>(ConvoQueue);
        ...
        public override void OnHarmfulAction(Mobile aggressor, bool isCriminal)
        {   // call for reinforcements!
            base.OnHarmfulAction(aggressor, isCriminal);
