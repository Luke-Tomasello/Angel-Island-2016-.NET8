...
namespace Server.Factions
{
    public class Sigil : BaseSystemController
    {
        ...
        public static readonly TimeSpan CorruptionGrace = TimeSpan.FromMinutes((Core.RuleSets.SERules()) ? 30.0 : 15.0);

        // Sigil must be held at a stronghold for this amount of time in order to become corrupted
        public static readonly TimeSpan CorruptionPeriod = ((Core.RuleSets.SERules()) ? TimeSpan.FromHours(10.0) : TimeSpan.FromHours(24.0));
