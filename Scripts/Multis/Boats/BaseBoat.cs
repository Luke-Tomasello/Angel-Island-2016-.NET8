...
namespace Server.Multis
{
    ...
    public abstract class BaseBoat : BaseMulti
    {
        ...
        public static bool IsValidLocation(Point3D p, Map map)
        {
            ...
            if ((Core.RuleSets.AngelIslandRules() || Core.RuleSets.RenaissanceRules()) && m_AIRect.Contains(p))
                return false;
        ...
        public bool Move(Direction dir, int speed, bool message)
        {
            ...
            if ((Core.RuleSets.AngelIslandRules() || Core.RuleSets.RenaissanceRules()) && m_AIRect.Contains(new Point2D(newX, newY)))
            {
                if (message && m_TillerMan != null)
