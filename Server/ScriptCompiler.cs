...
namespace Server
{
    public class ScriptCompiler
    {
        ...
        public static void AllInOneInit()
        {
        ...
        public static bool Compile(bool debug)
        {
            ...
            /* Adam: Always use the compiled 'Scripts.dll' as the compiler used for late compilation
             * doesn't support many new constructs.
             */
//#if !DEBUG
#if false
