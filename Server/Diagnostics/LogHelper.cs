...
namespace Server.Diagnostics
{
    public class LogHelper
    {
        ...
        private static string GetRootSerial(object root)
        {
            if (root is Mobile mobile2)
                return mobile2.Serial.ToString();
            else if (root is Item item2)
                return item2.Serial.ToString();
            else
                return null;
        }
