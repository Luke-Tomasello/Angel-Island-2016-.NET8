...
/* Server/World.cs
 * CHANGELOG
 *  8/10/2024: Adam (World.dat),
 *      Simply do the default thing without the exception.
 *	3/4/10, Adam
    ...
    public class World
    {
		...
		*/
        ...
        public static void LoadSystem()
        {
            ...
            // 8/10/2024: Adam: Simply do the default thing without the exception.
            if (!File.Exists("Saves/World.dat"))
            {
